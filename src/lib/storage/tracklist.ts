...
// import { BaseTable } from "@/utils/indexedDB/core/base";
...
// ) => {
//   try {
//     const localFiles = new FilesLocalSongsManager();
//     const localTracklist = new TracklistLocalSongsManager();

//     let filesDb: BaseTable<any> | undefined = undefined;
//     let tracklistDb: BaseTable<any> | undefined = undefined;
...
//       filesDb = localFiles;
//       tracklistDb = localTracklist;
//     }

//     if (!filesDb || !tracklistDb) {
//       return false;
//     }
