...
import { getInstrumentName } from "./config";

let audioContext: AudioContext | null /*: null | {}*/ = null;
...
export const instrumentsMap: any /*: InstrumentsMap */ = {};

export const isInstrumentLoaded = (instrumentName: any) => {
  return instrumentName in instrumentsMap;
};

export const getInstrument = (instrumentName: any) => {
...
export const loadInstruments = (midiPlayer: any) => {
  const instruments = midiPlayer.instruments;
  const instrumentNames = instruments.map((instr: any) =>
    getInstrumentName(instr)
  );
  const loadInstruments = instrumentNames.map((instrumentName: any) =>
