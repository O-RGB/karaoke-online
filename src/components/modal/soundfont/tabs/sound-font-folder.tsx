...
import { saveSoundFontStorage, getSoundFontStorage } from '@/lib/storage/soundfont';
...
interface SoundfontFolderProps {
    ...
    removeSF2Local: (filename: string) => void
}

const SoundfontFolder: React.FC<SoundfontFolderProps> = ({ loading, engine, soundFontStorage, setLoading, getSoundFontList, removeSF2Local, updateSoundFont }) => {
    return (
                ...
                <div className="flex flex-col gap-1 ">
                    ...
                    <div className="relative w-fit lg:w-full">
                        ...
                        <div className=" border flex gap-2 flex-col items-center p-2 px-4 rounded-md ">
                            ...
                            <div className="text-sm text-wrap break-all">{engine?.soundfontName}</div>
                        </div>
                    </div>
                </div>
            </div>
